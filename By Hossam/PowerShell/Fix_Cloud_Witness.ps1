...
$action = New-ScheduledTaskAction -Execute "PowerShell.exe" -Argument "-NoProfile -WindowStyle Hidden -Command `"Set-ClusterQuorum -CloudWitness -AccountName your-storage-account -AccessKey '$key' | Out-File C:\temp\cluster-result.txt`""
